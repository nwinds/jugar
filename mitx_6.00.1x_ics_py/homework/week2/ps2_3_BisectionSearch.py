...
#correct(1/30)
epsilon = 0.01
def oneYearPayment(balance, monthlyInterestRate, fixedMonthlyPayment):
    paid = 0.0
...
def minPaymentWithinOneYear(balance, annualInterestRate, epsilon):
    ...
    ans = (high + low) / 2.0
    while True:
        unpaiedBalance = oneYearPayment(balance, monthlyInterestRate, ans)
...
"""
minPaymentWithinOneYear(320000, 0.2, epsilon)
minPaymentWithinOneYear(999999, 0.18, epsilon)
